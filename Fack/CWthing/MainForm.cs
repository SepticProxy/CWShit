...
namespace CWthing
{
    ...
    public partial class RennysThing : Form
    {
        ...
        public IntPtr PlayerBase = (IntPtr)0x1046C478;
        public IntPtr ZMXPScaleBase = (IntPtr)0x10494470;
        public IntPtr TimeScaleBase = (IntPtr)0xF530694;
        public IntPtr CMDBufferBase = (IntPtr)0x11CD09C0;
        public IntPtr XPScaleZM = (IntPtr)277247152;
        public IntPtr GunXPScaleZM = (IntPtr)0x10494470;
        ...
        private void btnOnOff_Click(object sender, EventArgs e)
        {
            ...
            if (trainerOn)
            {
                ...
                btnOnOff.ForeColor = Color.Purple;
                ConsoleOut("Enabled; Were Vibin Now Bitches!");
            }
            else
            {
        ...
        private void RennysThing_Load(object sender, EventArgs e)
        {
            ...
            ConsoleOut("Edited by user SepticProxy");
